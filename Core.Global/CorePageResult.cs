...
{
    public class CorePageResult<T> : CoreResult<T>
    {
        /// <summary>
        /// 获取一个当前类型的空值。
        /// </summary>
        public static readonly CorePageResult<T> Empty = new CorePageResult<T>(0, 0, 0, 0, default(T));
        ...
        public CorePageResult(int totalRecords, int totalPages, int pageSize, int pageNumber, T data)
        {
