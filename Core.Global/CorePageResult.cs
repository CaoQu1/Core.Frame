...
{
    public class CorePageResult<T> : IEnumerable<T>, ICollection<T>
    {
        /// <summary>
        /// 获取一个当前类型的空值。
        /// </summary>
        public static readonly CorePageResult<T> Empty = new CorePageResult<T>(0, 0, 0, 0, null);
        ...
        public CorePageResult(int totalRecords, int totalPages, int pageSize, int pageNumber, List<T> data)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj == (object)null)
                return false;
            var other = obj as CorePageResult<T>;
        ...
        public static bool operator ==(CorePageResult<T> a, CorePageResult<T> b)
        {
